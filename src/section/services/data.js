...
const data = [
  {
    ...
    desc: "HTML5/CSS Development, Custom Web App Development, Fully Responsiveness and Developer handoff.",
  },
  // {id: 4, icon: </> , title:'', desc:""},
  {
    id: 2,
    icon: <FaServer />,
    title: "DataBase knowledge",
    desc: "Achieve data mastery, Advance automation, Prototyping & testing, Managed Data Services and Consultative Services.",
  },
  {
    id: 3,
    icon: <AiFillAppstore />,
    title: "App Development",
    desc: "Unlike other developers in the market, I will building an app that runs on both IOS and Android devices without ant extra cost to you.",
  },
];
export default data;
